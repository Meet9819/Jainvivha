	...
	<div class="main-content">
		...
		<div class="col-lg-12 col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Add Membership Plan</h4>
					<!-- /.box-title -->
...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"],"media/plan/" . $_FILES["image"]["name"]);
 ...
 $title = $_POST['title'];
 	 $description = $_POST['description'];
 	  $price = $_POST['price'];
            ...
            $save=mysqli_query($con,"INSERT INTO plan (img,title,description,price) VALUES ('$img','$title','$description','$price')");
...
?>
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
											<textarea class="form-control" name="description" id="text" placeholder="Write your  Description"></textarea>  
					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						<thead>
							<tr>
								...
								<th>Image</th><th>Title</th><th>Description</th><th>price</th>
...
if(isset($_GET['del']))
{
    $SQL = mysqli_query($con,"DELETE FROM plan WHERE id=".$_GET['del']);
						...
						<tbody>
							<tr>
								 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:100px" src="media/plan/'.$row['img'].'"></td>
								<td>'.$row['title'].'</td>
								<td>'.substr($row['description'],0,180).'.. </td>
								<td>'.$row['price'].'</td>
								<td>
								<a href="planedit.php?edit_id='.$row['id'].'">
