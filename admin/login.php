...
<head>
  ...
  <title>DK &#8211; jainvivha Website | Admin Panel</title>
...
?>
		...
		<div class="inside"> 
			...
			<div class="frm-input">
				 ...
				 <input type="text" name="username" placeholder="Username" class="frm-inp" required=""><i class="fa fa-user frm-ico"></i></div>
			<!-- /.frm-input -->
			...
			<!-- /.row -->
			<div class="frm-footer">jainvivha © 2020.</div>
			<!-- /.footer -->
		</div>
		<!-- .inside -->
	</form>
