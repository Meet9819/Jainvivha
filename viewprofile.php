...
<?php include "db.php"; ?>
               ...
               <?php 
                       ...
                       $query=mysqli_query($conn,"SELECT * from `customer` where userID = $studentid");
    ...
    padding: 10px;
    font-weight: bold;">
            <a style="color: white" href="profile.php">Edit Profile</a>
        </div>
...
<li class="col-md-8 col-sm-6 col-xs-6">
<span class="mar-bottom-10">Age From <b><?php echo $partneragefrom;?> yrs</b> to <b><?php echo $partnerageto;?> yrs</b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>

<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Height - <b><?php echo $partnerheightfrom;?></b> to <b><?php echo $partnerheightto;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Required for Marrital Status : <b><?php echo $partnermaritialstatus;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Children Status : <b><?php echo $partnerchildrenstatus;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Religion / Caste - <b><?php echo $partnerreligion;?></b> / <b><?php echo $partnercaste;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Mother Tongue - <b><?php echo $partnermothertongue;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Country Living in - <b><?php echo $partnercountrytitle; ?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">State Living in - <b><?php echo $partnerstatetitle; ?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>  <?php 
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">City Living in - <b><?php echo $partnercitytitle; ?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Education - <b><?php echo $partnereducation; ?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Employed in - <b><?php echo $partneremployedin;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Occupation - <b><?php echo $partneroccupation;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Annual Income - <b><?php echo $partnerannualincome;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
...
<li class="col-md-8 col-sm-12 col-xs-6">
<span class="mar-bottom-10">Manglik - <b><?php echo $partnermanglik;?></b></span>
</li>
<li class="col-md-4 col-sm-6 col-xs-6 text-center">
<span class="mar-bottom-10">---</span>
</li>
